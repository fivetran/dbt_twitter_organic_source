...
{% set columns = [
    ...
    {"name": "favourites_count", "datatype": dbt_utils.type_int()},
    {"name": "followers_count", "datatype": dbt_utils.type_int()},
    {"name": "friends_count", "datatype": dbt_utils.type_int()},
    ...
    {"name": "listed_count", "datatype": dbt_utils.type_int()},
    {"name": "location", "datatype": dbt_utils.type_string()},
    {"name": "name", "datatype": dbt_utils.type_string()},
    {"name": "profile_background_image_url", "datatype": dbt_utils.type_string()},
    {"name": "profile_background_image_url_https", "datatype": dbt_utils.type_string()},
    {"name": "profile_background_tile", "datatype": "boolean"},
    {"name": "profile_banner_url", "datatype": dbt_utils.type_string()},
    {"name": "profile_image_url", "datatype": dbt_utils.type_string()},
    {"name": "profile_image_url_https", "datatype": dbt_utils.type_string()},
    {"name": "profile_use_background_image", "datatype": dbt_utils.type_string()},
    {"name": "protected_user", "datatype": "boolean"},
    {"name": "screen_name", "datatype": dbt_utils.type_string()},
    {"name": "statuses_count", "datatype": dbt_utils.type_int()},
    {"name": "time_zone", "datatype": dbt_utils.type_string()},
    {"name": "url", "datatype": dbt_utils.type_string()},
    {"name": "utc_offset", "datatype": dbt_utils.type_int()},
